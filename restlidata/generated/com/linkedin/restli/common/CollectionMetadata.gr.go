...
var _CollectionMetadataRequiredFields = restlicodec.RequiredFields{
	"start",
	"count",
	"links",
}
...
func (c *CollectionMetadata) UnmarshalRestLi(reader restlicodec.Reader) (err error) {
	err = reader.ReadRecord(_CollectionMetadataRequiredFields, func(reader restlicodec.Reader, field string) (err error) {
		switch field {
		case "start":
