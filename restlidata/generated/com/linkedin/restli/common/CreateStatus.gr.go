...
var _CreateStatusRequiredFields = restlicodec.RequiredFields{
	"status",
}
...
func (c *CreateStatus) UnmarshalRestLi(reader restlicodec.Reader) (err error) {
	err = reader.ReadRecord(_CreateStatusRequiredFields, func(reader restlicodec.Reader, field string) (err error) {
		switch field {
		case "status":
