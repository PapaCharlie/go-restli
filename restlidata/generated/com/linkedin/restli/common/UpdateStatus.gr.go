...
var _UpdateStatusRequiredFields = restlicodec.RequiredFields{
	"status",
}
...
func (u *UpdateStatus) UnmarshalRestLi(reader restlicodec.Reader) (err error) {
	err = reader.ReadRecord(_UpdateStatusRequiredFields, func(reader restlicodec.Reader, field string) (err error) {
		switch field {
		case "status":
