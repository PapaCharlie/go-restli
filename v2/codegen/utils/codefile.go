...
var (
	DoNotEditHeader = `Code generated by "github.com/PapaCharlie/go-restli/v2"; DO NOT EDIT.`
	...
	HeaderTemplate = template.Must(template.New("header").Parse(DoNotEditHeader + `
...
func (f *CodeFile) Write(outputDir string) (err error) {
	...
	filename := filepath.Join(
		outputDir,
		strings.TrimPrefix(f.PackagePath, f.PackageRoot),
		f.Filename+GeneratedFileSuffix,
	)
