// Code generated by "stringer -type=RestLiMethod -trimprefix Method_"; DO NOT EDIT.
...
func (i RestLiMethod) String() string {
	if i < 0 || i >= RestLiMethod(len(_RestLiMethod_index)-1) {
		return "RestLiMethod(" + strconv.FormatInt(int64(i), 10) + ")"
	}
